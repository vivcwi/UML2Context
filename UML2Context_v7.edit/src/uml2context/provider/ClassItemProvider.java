...
/**
 * This is the item provider adapter for a {@link uml2context.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2contextPackage.Literals.CLASS__IS_ABSTRACT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2contextPackage.Literals.CLASS__SUPER_CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Uml2contextPackage.Literals.CLASS__OPERATIONS);
			childrenFeatures.add(Uml2contextPackage.Literals.CLASS__OWNED_PROPERTY);
		}
	...
	public String getText(Object object) {
		String label = ((uml2context.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(uml2context.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Uml2contextPackage.Literals.CLASS__OPERATIONS,
				 Uml2contextFactory.eINSTANCE.createOperation()));

		newChildDescriptors.add
			(createChildParameter
				(Uml2contextPackage.Literals.CLASS__OWNED_PROPERTY,
