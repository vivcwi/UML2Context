...
/**
 * This is the item provider adapter for a {@link uml2context.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2contextPackage.Literals.ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCommentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_comments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_comments_feature", "_UI_Element_type"),
				 Uml2contextPackage.Literals.ELEMENT__COMMENTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUseCasePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_UseCase_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_UseCase_feature", "_UI_Element_type"),
				 Uml2contextPackage.Literals.ELEMENT__USE_CASE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
