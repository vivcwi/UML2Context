...
/**
 * This is the item provider adapter for a {@link uml2context.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConstraintSpecificationPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2contextPackage.Literals.CONSTRAINT__CONSTRAINED_ELEMENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Uml2contextPackage.Literals.CONSTRAINT__CONTEXT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Constraint Specification feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addConstraintSpecificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_constraintSpecification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_constraintSpecification_feature", "_UI_Constraint_type"),
				 Uml2contextPackage.Literals.CONSTRAINT__CONSTRAINT_SPECIFICATION,
				 true,
				 false,
				 false,
