...
/**
 * This is the item provider adapter for a {@link uml2context.Duty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DutyItemProvider
	extends ActionClassItemProvider
	implements
	 ...
	 * @generated
	 */
	public DutyItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Duty"));
	}
	...
	public String getText(Object object) {
		String label = ((Duty)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Duty_type") :
			getString("_UI_Duty_type") + " " + label;
	}
