 ...
 * <ul>
 *   <li>{@link uml2context.impl.GeneralizationImpl#getGeneral <em>General</em>}</li>
 *   <li>{@link uml2context.impl.GeneralizationImpl#getSpecific <em>Specific</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationImpl extends DirectedRelationshipImpl implements Generalization {
	...
	protected EClass eStaticClass() {
		return Uml2contextPackage.Literals.GENERALIZATION;
	}
		...
		if (general != null && general.eIsProxy()) {
			...
			if (general != oldGeneral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Uml2contextPackage.GENERALIZATION__GENERAL, oldGeneral, general));
			}
		}
		return general;
	}
	...
	public void setGeneral(Classifier newGeneral) {
		...
		general = newGeneral;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Uml2contextPackage.GENERALIZATION__GENERAL, oldGeneral, general));
	}
	...
	public Classifier getSpecific() {
		if (specific != null && specific.eIsProxy()) {
			...
			if (specific != oldSpecific) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Uml2contextPackage.GENERALIZATION__SPECIFIC, oldSpecific, specific));
			}
		}
		return specific;
	}
	...
	public void setSpecific(Classifier newSpecific) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Uml2contextPackage.GENERALIZATION__SPECIFIC, oldSpecific, specific));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Uml2contextPackage.GENERALIZATION__GENERAL:
				if (resolve) return getGeneral();
				return basicGetGeneral();
			case Uml2contextPackage.GENERALIZATION__SPECIFIC:
